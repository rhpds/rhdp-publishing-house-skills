...
See @showroom/skills/config-reviewer/references/validation-rules.md for all rules, severity definitions, and the report format.
See @showroom/skills/config-helper/references/showroom-patterns.md for pattern detection and config expectations.
See @showroom/skills/config-helper/references/config-files.md for file format reference.
...
Apply all rules from @showroom/skills/config-reviewer/references/validation-rules.md. For each rule:
